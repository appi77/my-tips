...
./expcloud-setup-databases.sh -dbHost [mypostgres.company.com](http://mypostgres.company.com/) 
-dbAdminPwd <password for postgres user> -otdsUserPwd <password for
otdsUser> -expcloudUserPwd <password for expcloudUser> -rmaUserPwd
<password for rmaUser> -expaiUserPwd <password for expaiUser>
...
```
[values.custom.yaml](values.custom.yaml)
...
RMA용 사용자 생성 (이미 안 했을 경우)
RabbitMQ Pod에 접속해서 사용자 생성:
